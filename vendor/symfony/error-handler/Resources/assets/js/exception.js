            ...
            for (j = 0; j < tabNavigation.length; j++) {
                ...
                tabNavigation[j].addEventListener('click', function (e) {
                    ...
                    for (var k = 0; k < tabNavigation.length; k++) {
                        var tabId =
                            tabNavigation[k].getAttribute('data-tab-id');
                ...
                values.forEach(function (value, i) {
                    ...
                    addEventListener(option, 'click', function () {
                        if ('choice' === type) {
                            ...
                            if (
                                i ===
                                this.parentNode.querySelectorAll('.active')
                                    .length -
                                    1
                            ) {
                                return;
                            ...
                            filters
                                ...
                                .forEach(function (row) {
                                    if (
                                        i <
                                        indexed[row.dataset['filter' + ucName]]
                                    ) {
                    ...
                    if ('choice' === type) {
                        active =
                            null === defaults || 0 <= defaults.indexOf(value);
                    } else if ('level' === type) {
                        active = i <= defaults;
